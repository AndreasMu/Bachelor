...
plt.plot(agelabel, compdata, 'b',label='100-1500-750')
plt.plot(agelabel, compdata1, 'r',label='100-100-100')
#plt.plot(agelabel, compdata2, 'r',label='10-100-100')
#plt.plot(agelabel, compdata3, 'r',label='100-50-100')
#plt.plot(agelabel, compdata4, 'r',label='100-100-50')
plt.rc('font', size=20)
